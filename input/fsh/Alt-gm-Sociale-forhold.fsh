Profile: AltGMSocialeForholdObs
Id: AltGMSocialeForholdObs
...
* extension[GMModelElementReference][JuridiskMedforælder].valueReference only Reference(AltGMJuridiskMedforaelderObs)
* extension[GMModelElementReference][Partner].valueReference only Reference(AltGMPartnerObs)
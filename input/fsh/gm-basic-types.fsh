...
* section.entry contains
    ...
    familiehistorie-arvelige-sygdomme 0..1 and
    fertilitetsbehandling 0..1 and
    fravaersmelding-sygemelding 0..1 and
    fysiske-data 0..1 and
    gravides-allergi 0..1 and
    konsangvinitet 0..1 and
    medicin-og-naturlaegemidler 0..1 and
    praenatal-risikovurderingsoenskes 0..1 and
    praenatal-ultralyd 0..1 and
    psykisk-sygdom-af-relevans 0..1 and
    screeningsplanlaegning 0..1 and
    social-saarbarhed-af-relevans 0..1 and
    sociale-forhold 0..1 and
    somatisk-sygdom 0..1 and
    sprog 0..1 and
    tidligere-abort 0..1 and

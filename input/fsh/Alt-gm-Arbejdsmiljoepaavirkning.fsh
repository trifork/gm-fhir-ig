Profile: AltGMArbejdsmiljoepaavirkningObs
Id: AltGMArbejdsmiljoepaavirkningObs
...
* extension[GMModelElementReference][TypePåvirkning].valueReference only Reference(AltGMTypePaavirkningObs)
Profile: AltGMFamiliehistorieArveligeSygdommeObs
Id: AltGMFamiliehistorieArveligeSygdommeObs
...
* extension[GMModelElementReference][Hæmoglobinopatiscreening].valueReference only Reference(AltGMHaemoglobinopatiscreeningObs)
* extension[GMModelElementReference][HæmoglobinopatiIFamilien].valueReference only Reference(AltGMHaemoglobinopatiIFamilienObs)
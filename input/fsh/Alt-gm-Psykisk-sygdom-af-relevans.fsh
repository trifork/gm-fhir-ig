Profile: AltGMPsykiskSygdomAfRelevansObs
Id: AltGMPsykiskSygdomAfRelevansObs
...
* component 0..1
* component contains
    psykisk-sygdom-af-relevans 0..1
...
* extension[GMModelElementReference][PsykiskSygdom].valueReference only Reference(AltGMPsykiskSygdomObs)
Profile: AltGMTidligereFoedselObs
Id: AltGMTidligereFoedselObs
...
* extension[GMModelElementReference][Barn].valueReference only Reference(AltGMBarnObs)
* extension[GMModelElementReference][Fødselsforløbstræk].valueReference only Reference(AltGMFoedselsforloebstraekObs)
* extension[GMModelElementReference][Graviditetsforløbstræk].valueReference only Reference(AltGMGraviditetsforloebstraekObs)